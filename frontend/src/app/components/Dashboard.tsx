        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-start mb-10">
            <div>
              <button
                onClick={() => navigate("/")}
                className="text-sm text-gray-500 hover:text-gray-900 mb-4 transition"
              >
                ← Back to Home
              </button>
              ...
              <p className="text-gray-500 mt-4 text-lg">
                Zalando Customer Care Management Dashboard
              </p>
            </div>
                ...
                {showNotifications && (
                  <div className="absolute right-0 mt-3 w-80 bg-white border border-gray-200 rounded-2xl shadow-xl p-4 z-50">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition cursor-pointer">
                        New complaint submitted by Sarah
                        Williams
                      </div>

                      <div className="p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition cursor-pointer">
                        Logistics department updated ticket
                        CMP-002
                      </div>
                    </div>
                  </div>
